...
if (typeof usi_js === 'undefined') {
	usi_js = {
		campaign: {
			id: '7147831790767858749659',
			site_id: 44543,
			config_id: 94011,
			company_id: 5698,
			key: 'desktop_english',
			link: '',
			deep_link: 'https://shutterstock.7eer.net/c/16669/861128/1305?url=',
			domains: '',
		...
		display_vars: {
			...
			css: ".usi_display * {\tfont-size: 1em;\tline-height: 1.2;\tbox-sizing: border-box;\tcolor: inherit;\tfont-family: Roboto, Arial;}.usi_display {\tcolor: #000;\tfont-family: Roboto, Arial;}.usi_header_text {  position: absolute;  top: 15%;  left: 9%;  width: 78%;  font-size: 2em;  font-weight:bold;  font-family: inherit;    color: #fff;  letter-spacing: -1px;}.usi_header_text2 {  position: absolute;  top: 31%;  left: 9%;  width: 78%;  font-size: 3em;  font-weight:bold;  font-family: inherit;    color: #fff;  letter-spacing: -1px;}.usi_bullet_container {  position: absolute;  display: block;  top: 42%;  left: 9%;  }.usi_bullet_text {  display: block;  font-size: 1.7em;  color: #fff;  padding-bottom: 6px;  width: 100%;}/* Submit Button */.usi_submitbutton:hover, .usi_submitbutton:active, .usi_submitbutton:focus {\tbackground: none;\tborder: none;}.usi_submitbutton {\tposition: absolute;  top: 66.5%;  left: 9%;  width: 43.4%;  height: 11.4%;\tdisplay: inline-block;\tbackground: none;\tborder: none;\tmargin: 0;\tpadding: 0;\tcursor: pointer;  text-align: center;  color: #fff;  font-weight: bold;  font-size: 1.4em;}",
			focus_trap: 0
		},
		timers: {
			display_timer: -1,
    ...
    usi_js.deep_link(usi_app.messaging.url);
  }  
};

var fontsize1 = "3em";
if (usi_app.messaging.header1.length > 25) {
	var fontsize1 = "2em";
}
var fontsize2 = "4em";
if (usi_app.messaging.header2.length > 30) {
	var fontsize2 = "3em";
}

usi_js.display_vars.p1_html = [
  '<div class="usi_header_text" style="font-size:',fontsize1,'">',usi_app.messaging.header1,'</div>',
  '<div class="usi_header_text2" style="font-size:',fontsize2,'">',usi_app.messaging.header2,'</div>',
	'<button class="usi_submitbutton" onclick="usi_js.click_cta();" type="button" aria-label="',usi_app.messaging.cta,'">',usi_app.messaging.cta,'</button>',
].join('');
